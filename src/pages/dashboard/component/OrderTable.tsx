      ...
      <div className="overflow-x-auto mt-6 border border-gray-200 rounded-xl shadow-sm">
        <table className="w-full min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-6 py-4 text-left text-xs font-semibold tracking-wide text-gray-500">
                Serial No.
              </th>
              <th className="px-6 py-4 text-left text-xs font-semibold tracking-wide text-gray-500">
                Order ID
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-block px-3 py-1 text-xs font-medium rounded-full capitalize ${getStatusColor(order.status || "delivered")}`}
                      >
