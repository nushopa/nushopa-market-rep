    ...
    <div className={`space-y-1 ${className}`}>
      ...
      <div className="relative">
        <select
          ...
          disabled={disabled}
          className={`
  w-full pl-3 pr-10 py-2 text-sm border rounded-lg appearance-none transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-transparent text-gray-700 dark:text-black
  ${disabled 
